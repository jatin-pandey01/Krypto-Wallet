...
import { TransactionContext, transactions } from '../context/TransactionContext';
...
//    transactionHash: number;
    ...
    // addressTo: string;
// }
const TransactionCard = ({keyword,message,timestamp,addressFrom,amount,addressTo,url}) => {
  const gif = useGif({ keyword });
  // console.log("keyword = "+ keyword + "Gif = ");
  if(keyword)
  console.log(gif);
